...
class ThePanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        welcome = wx.StaticText(self, id=wx.ID_ANY, label="Boiler Starts Here", pos=(20,80))
        self._textbox = wx.TextCtrl(parent = self, value="Enter Here", pos=(20,60))
        self._button = wx.Button(parent=self, label = "submit", pos=(20,120))
        self._button.Bind(wx.EVT_BUTTON, self.onSubmit) # the action to take
